...
const Main = () => {
  ...
  ========================= */
    ...
    const updateSkillField = (domainId, value) => {
        setSkillFields((prev) =>
            prev.map((domain) =>
                domain.id === domainId ? { ...domain, name: value } : domain,
            ),
        );
    };
    ...
    const deleteSkillField = async (domainId) => {
        const domain = skillFields.find((item) => item.id === domainId);
    ...
    const addSpecialization = async (domainId) => {
        ...
        try {
            const response = await fetch(`${API_URL}/api/skills/sectors/`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const updateSpecialization = (domainId, sectorId, value) => {
        setSkillFields((prev) =>
            prev.map((domain) =>
                domain.id === domainId
                    ? {
    ...
    const deleteSpecialization = async (domainId, sectorId) => {
        const domain = skillFields.find((item) => item.id === domainId);

        const sector = domain?.sectors.find((item) => item.id === sectorId);
    ...
    const addCategory = async (domainId, sectorId) => {
        const domain = skillFields.find((item) => item.id === domainId);
        ...
        try {
            const response = await fetch(`${API_URL}/api/skills/sections/`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const updateCategory = (domainId, sectorId, sectionId, value) => {
        setSkillFields((prev) =>
            prev.map((domain) =>
                domain.id === domainId
                    ? {
    ...
    const deleteCategory = async (domainId, sectorId, sectionId) => {
        const domain = skillFields.find((item) => item.id === domainId);

        const sector = domain?.sectors.find((item) => item.id === sectorId);

        const section = sector?.sections.find((item) => item.id === sectionId);
    ...
    const addSkill = async (domainId, sectorId, sectionId) => {
        const domain = skillFields.find((item) => item.id === domainId);
        ...
        try {
            const response = await fetch(`${API_URL}/api/skills/skills/`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    const deleteSkill = async (domainId, sectorId, sectionId, skillId) => {
        const domain = skillFields.find((item) => item.id === domainId);
        ...
        const skill = section?.skills.find((item) => item.id === skillId);
        ...
        try {
            for (const domain of skillFields) {
                ...
                // UPDATE EXISTING DOMAIN
                    ...
                    await fetch(`${API_URL}/api/skills/domains/${domain.id}/`, {
                        method: "PATCH",
                        headers: {
                            "Content-Type": "application/json",
                        },
  ...
  ========================= */
    ...
    const deleteEducation = async (id) => {
        ...
        try {
            const response = await fetch(
                `${API_URL}/api/qualifications/educationcards/${id}/`,
                {
                    method: "DELETE",
                },
            );
    ...
    const deleteCertificate = async (id) => {
        ...
        try {
            const response = await fetch(
                `${API_URL}/api/qualifications/certificatecards/${id}/`,
                {
                    method: "DELETE",
                },
            );
            ...
            for (const item of education) {
                ...
                if (item.isNew) {
                    response = await fetch(
                        `${API_URL}/api/qualifications/educationcards/`,
                        {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
  ...
  ========================= */
    ...
    useEffect(() => {
        const fetchAchievements = async () => {
            try {
                const response = await fetch(
                    `${API_URL}/api/achievements/achievementcards/`,
                );
    ...
    const deleteAchievement = async (id) => {
        ...
        try {
            const response = await fetch(
                `${API_URL}/api/achievements/achievementcards/${id}/`,
                {
                    method: "DELETE",
                },
            );
        ...
        try {
            ...
            for (const achievement of achievements) {
                ...
                if (achievement.isNew) {
                    ...
                    response = await fetch(
                        `${API_URL}/api/achievements/achievementcards/${achievement.id}/`,
                        {
                            method: "PATCH",
                            headers: {
                                "Content-Type": "application/json",
  ...
  ========================= */
    ...
    useEffect(() => {
        const fetchProjects = async () => {
            try {
                const response = await fetch(
                    `${API_URL}/api/projects/projectcards/`,
                );
    ...
    const deleteProject = async (id) => {
        ...
        try {
            const response = await fetch(
                `${API_URL}/api/projects/projectcards/${id}/`,
                {
                    method: "DELETE",
                },
            );
        ...
        try {
            ...
            for (const project of projects) {
                ...
                if (project.isNew) {
                    ...
                    response = await fetch(
                        `${API_URL}/api/projects/projectcards/${project.id}/`,
                        {
                            method: "PATCH",
                            body: formData,
                        },
        ...
        <main className={styles.main}>
                ...
                <div className={styles.statsGrid}>
                    <div className={styles.statEditor}>
                        ...
                        <div className={styles.counter}>
                            <button
                                onClick={() => decrease(setYearsExperience)}
                            >
                                <i className="fa-solid fa-minus"></i>
                            </button>

                            <button
                                onClick={() => increase(setYearsExperience)}
                            >
                    ...
                    <div className={styles.statEditor}>
                        ...
                        <div className={styles.counter}>
                            <button
                                onClick={() => decrease(setProjectsCompleted)}
                            >
                                <i className="fa-solid fa-minus"></i>
                            </button>

                            <button
                                onClick={() => increase(setProjectsCompleted)}
                            >
                                <i className="fa-solid fa-plus"></i>
                            </button>
                        </div>
            ...
            <section className={styles.section}>
                ...
                <div className={styles.aboutEditor}>
                    ...
                    //res.cloudinary.com/m6jjifei/${about[0].image}`
                                    }
                                    alt="About Picture"
                                />
                            ) : (
            ...
            <section className={styles.section}>
                ...
                <div className={styles.skillsStructure}>
                    {skillFields.map((domain) => (
                        <div className={styles.skillField} key={domain.id}>
                            {/* DOMAIN */}
                            ...
                            <div className={styles.fieldTitle}>
                                ...
                                <button
                                    ...
                                    onClick={() => deleteSkillField(domain.id)}
                                >
                            ...
                            <button
                                className={styles.addNestedButton}
                                onClick={() => addSpecialization(domain.id)}
                            >
                                <i className="fa-solid fa-plus"></i>
                                Add Sector
                            </button>
                ...
                <div className={styles.sectionActions}>
                    <button className={styles.saveButton} onClick={saveSkills}>
                        <i className="fa-solid fa-floppy-disk"></i>
                        Save Changes
                    </button>
                </div>
                ...
                <div className={styles.subSection}>
                    <div className={styles.subSectionHeader}>
                        <div>
                            ...
                            <div>
                                <h3>Certificates</h3>
                                <span>
                                    Professional certificates and verification
                                    links
                                </span>
                            </div>
                        </div>
                    ...
                    <div className={styles.cardsList}>
                        {certificates.map((certificate) => (
                          ...
                          //res.cloudinary.com/m6jjifei/${certificate.image}`
                                                }
                                                alt="Certificate"
                                            />
                                        ) : (
                ...
                <div className={styles.cardsList}>
                    {projects.map((project) => (
                        <div className={styles.editorCard} key={project.id}>
                          ...
                          //res.cloudinary.com/m6jjifei/${project.image}`
                                            }
                                            alt={project.name}
                                        />
                                    ) : (
