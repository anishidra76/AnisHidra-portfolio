...
function Qualifications({ openModal }) {
                            ...
                            <div className="edu-list" key={educations.id}>
                                <div className="glow-card edu-item">
                                    <div className="educdev">
                                        <h4>{educations.specialization}  <span>|</span>  {educations.field}</h4>
                                        <p className="edu-meta">{educations.entity} <span>&middot;</span> {educations.date}</p>
                                    </div>
                                    <span className="edu-badge">{educations.degree}</span>
                                </div>
                            </div>
                        ))}
